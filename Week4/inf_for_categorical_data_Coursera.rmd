...
```{r perc-atheist-us12}
us12 %>%
    summarise(at_rate = sum(response=="atheist")/n())
...
1. Independence: 1000 <10% of Americans and Win Gallup samples randomly. Whether one American in the sample is an atheist is independent of another.

2. Sample size/skew: 5% is 50 Americans. Since the success-failure condition is met, we can assume that the sampling distribution of the proportion is nearly normal.
...
inference(y=response, x=year, data=spain, statistic="proportion",type="ht",null=0,alternative="twosided",method="theoretical",succes="atheist")
```
...
inference(y=response, x=year, data=us, statistic="proportion",type="ht",null=0,alternative="twosided",method="theoretical",succes="atheist")
